...
- Require Rails 7.2+ and Ruby 3.1+.
- Replace timecop with Rails' built-in `ActiveSupport::Testing::TimeHelpers`.
- Update development dependencies (rspec, capybara, rake).
- Fix `RubyVersion` check compatibility with Ruby 3.x pathname handling.
